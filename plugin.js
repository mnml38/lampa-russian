(function () {
            ...
            .then(function (catalog) {
                ...
                return Promise.all(
                    items.map(function (entry) {
                        return searchTmdb(entry.title).then(
                            function (card) {
                                if (!card) return null;
    ...
    function RussianSections() {
        ...
        var html = $(
            '<div class="russian-sections"></div>'
        );
    ...
    function addStyles() {
        if ($('#russian-catalog-style').length) return;
